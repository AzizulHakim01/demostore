...
const QualityTab = () => {
  return (
    <div className="w-[1152px] mx-auto md:h-[550px] bg-[#F5F7F9]">
      <div className="grid md:grid-cols-4 grid-cols-1 px-4 gap-7">
        <div className="flex  items-center justify-center flex-col h-[550px] gap-5">
